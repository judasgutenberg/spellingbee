...
if (src && src.length > 0) {
  ...
  document.open();
  document.write("<form method='post' action='handle.asp'>Paste <a href=view-source:https://www.nytimes.com/puzzles/spelling-bee target=source>source for today's New York Times Spelling Bee</a> here:<br/><textarea name='src'></textarea><br/><input type='submit' value='Let us go!'/></form>");
  document.close();
}
