...
if (src && src.length > 0) {
  ...
  document.open();
  document.write("<div style='font-family:courier'><form method='post' action='handle.asp'>Paste <a href=view-source:https://www.nytimes.com/puzzles/spelling-bee target=source>source for today's New York Times Spelling Bee</a><br/> here:<br/>");
