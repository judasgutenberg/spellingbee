...
if (strlen($src) > 0) {
    ...
    echo "window.answers = [" . $answers . "];" . PHP_EOL;
    echo "window.panagrams = [" . $panagrams . "];" . PHP_EOL;
    echo "var centerLetter = \"" . $centerLetter . "\";" . PHP_EOL;
    echo "var outerLetters = [" . $outerLetters . "];" . PHP_EOL;
    echo "window.letters = centerLetter + outerLetters.join(\"\") + \";\"" . PHP_EOL;
}
?>
    ...
    <link rel="preload" href="/spellingbee/bundle/kn5R8N9MZZ.css" as="style" onload="this.onload=null;this.rel='stylesheet'">

    <!-- AlpineJS -->
    <script src="/spellingbee/bundle/game.js" type="module"></script>
